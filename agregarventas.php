		...
		<div class="content">
			...
			if(isset($_POST['add'])){
				...
				if(mysqli_num_rows($cek) == 0){
						$insert = mysqli_query($con, "INSERT INTO empleados(codigo, nombres, lugar_nacimiento, fecha_nacimiento, direccion, telefono, DNI, estado,Fecha_Vencimiento,Email)
															VALUES('$codigo','$nombres', '$lugar_nacimiento', '$fecha_nacimiento', '$direccion', '$telefono', '$DNI', '$estado','$Fecha_Vencimiento','$Email')") or die();
						if($insert){
			...
			<form class="form-horizontal" action="" method="post">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input type="text" name="Fecha_Vencimiento" class="input-group date form-control" date="" data-date-format="dd-mm-yyyy" placeholder="00-00-0000" required>
					</div>
				</div>
